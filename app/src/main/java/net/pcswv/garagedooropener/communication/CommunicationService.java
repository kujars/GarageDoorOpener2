...
import net.pcswv.garagedooropener.utils.NotificationUpdateRunnable;
/**
...
public class CommunicationService extends IntentService {
    ...
    public static final String NOTIFICATION = "net.pcswv.garagedooropener.communication";
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        try {
            ...
            RPIHttpClient client = new RPIHttpClient(ipaddress, port);
